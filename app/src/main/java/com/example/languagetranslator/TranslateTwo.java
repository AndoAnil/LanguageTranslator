...
public class TranslateTwo {
    ...
    public static void TranslateTwo(int userone, int usertwo)
    {
                ...
                .addOnSuccessListener(
                        new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void v) {
                                ...
                                final String text = MainActivity.userTwo.getText().toString();
                                translate.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        startTranslate1(translator,MainActivity.userTwo.getText().toString());
                                    }
                                });
    ...
    private static void startTranslate1(FirebaseTranslator translater, String text){
                ...
                .addOnSuccessListener(
                        new OnSuccessListener<String>() {
                            ...
                            public void onSuccess(@NonNull String translatedText) {
                                ...
                                MainActivity.userOne.setText(translatedText);
                            }
                        })
                .addOnFailureListener(
                        new OnFailureListener() {
